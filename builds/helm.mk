install_cert_manager: ## Install or upgrade cert-manager
	helm upgrade cert-manager --repo https://charts.jetstack.io cert-manager \
...
install_nginx: ## Install or upgrade Nginx ingress controller
	helm upgrade nginx --repo https://kubernetes.github.io/ingress-nginx ingress-nginx \
...
install_argocd: ## Install or upgrade Argo CD
	helm upgrade argo-playground --repo https://argoproj.github.io/argo-helm argo-cd \
...
install_argo_rollouts: ## Install or upgrade Argo Rollouts
	helm upgrade argo-rollouts --repo https://argoproj.github.io/argo-helm argo-rollouts \
